...
ARCHITECTURE_NAME = 'cnn_color_kernels'
RESULTS_DIR = '../result'
...
class CNN:
    ...
    def build_model(self):
        ...
        layers = [
            InputLayer(),
            ConvolutionalLayer(kernel_size=(3, 3), num_channels=C, num_kernels=32),
            ReLULayer(),
            MaxPoolLayer(pool_size=2, stride=2),
            FlatteningLayer(),
            ReLULayer(),
            FullyConnectedLayer(sizeIn=32 * 15 * 15, sizeOut=self.num_classes),
            SoftmaxLayer(),
        ]
        return layers
